...
public class ByFragment extends BaseTagFragment implements IScanReceiver, ServerObserver.ServerDataReceiver {
        ...
        if (currentReceiverCode == SCAN_CODE_OPER) {
            ...
            if (data.getCode().equals("0")) {
                if (data.getDatas() != null && data.getDatas().getBagDatas() != null) {
                    ...
                    byEntity.setEquipmentId(Long.parseLong(mapList.get(0).get("id")));
                    ProcessItem item = new ProcessItem();
